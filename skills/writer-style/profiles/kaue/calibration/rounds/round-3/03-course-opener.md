...
That last module is the point of the other five. By week 8 you'll have deployed a working program to devnet and built a frontend that talks to it, and that's a portfolio piece, not a certificate — a live thing a hiring manager or a hackathon judge can click on, which is a kind of proof you can't get from watching videos.
